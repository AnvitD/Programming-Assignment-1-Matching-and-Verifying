...
The matching alogrithm will work with main.py. For the verify functions you will have to run the verify.py and scalabilityVerify.py files (verify.py, scalabilityVerify.py). For this, also make sure the output.txt is in the same directory. You will see the output in the terminal. Do not change the formatting of either the input or output files. 
